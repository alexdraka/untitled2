...
public class Main {
    ...
    public static String calc(String input) throws ScannerException {
       ...
       // if ((Arrays.asList(arr).contains(str[0]) == false) || (Arrays.asList(arr).contains(str[1]) == false))  {
       ...
       // }
        ...
        } else if (indexPlus != -1 & Arrays.asList(arrRoman).contains(str[0]) & Arrays.asList(arrRoman).contains(str[1])) {
            int result2 = romanInArabicCount1 + romanInArabicCount2;
            result = romans[result2 - 1];
        } else if (indexMinus != -1 & Arrays.asList(arrRoman).contains(str[0]) & Arrays.asList(arrRoman).contains(str[1])) {
            int result2 = romanInArabicCount1 - romanInArabicCount2;
            result = romans[result2 - 1];
        } else if (indexMultiply != -1 & Arrays.asList(arrRoman).contains(str[0]) & Arrays.asList(arrRoman).contains(str[1])) {
            int result2 = romanInArabicCount1 * romanInArabicCount2;
            result = romans[result2 - 1];
        } else if (indexDevide != -1 & Arrays.asList(arrRoman).contains(str[0]) & Arrays.asList(arrRoman).contains(str[1])) {
            int result2 = romanInArabicCount1 / romanInArabicCount2;
            result = romans[result2 - 1];
